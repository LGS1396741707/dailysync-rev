 ...
 */
// 佳明中国区账号及密码
export const GARMIN_USERNAME_DEFAULT ='928198081@qq.com';
export const GARMIN_PASSWORD_DEFAULT ='Mobile182';
// 佳明国际区区账号及密码
export const GARMIN_GLOBAL_USERNAME_DEFAULT ='928198081@qq.com';
export const GARMIN_GLOBAL_PASSWORD_DEFAULT ='Mobile182';
// 佳明迁移数量配置
export const GARMIN_MIGRATE_NUM_DEFAULT =769;
